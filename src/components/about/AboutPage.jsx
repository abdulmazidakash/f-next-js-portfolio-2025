    ...
    <div className=''>
        ...
        */}
            <div className='col-span-1 lg:col-span-3 order-2 lg:order-1 flex flex-col items-start justify-start'>
                ...
                <p className='font-medium text-justify text-dark'>This is <a target='_blank' href='https://github.com/abdulmazidakash' className='underline text-slate-600'>Abdul Mazid Akash</a>. I’m a student currently studying B.Sc. in Textile Engineering at Narsingdi Textile Engineering College. My hometown is Feni, but I’m now living in Narsingdi for my studies.</p>
                <p className='font-medium text-justify mt-4 text-dark'>I recently completed a web development course from <a target='_blank' href='https://www.programming-hero.com/' className='underline text-slate-600'>Programming Hero</a>. Right now, I’m building web applications using JavaScript, React.js, Node.js, and MongoDB. I enjoy creating websites that are both user-friendly and responsive.</p>
                <p className='font-medium text-justify mt-4 text-dark'>I’ve worked on several projects, including <a target='_blank' href='https://scholarship-hub-akash.netlify.app/' className='underline text-slate-600'>ScholarshipHub</a>, a scholarship management system. One of my main team projects is <a target='_blank' href='https://tickto-booking.netlify.app/' className='underline text-slate-600'>TickTo</a>, a bus ticket booking platform. In TickTo, I worked on real-time seat selection and secure payment features. This project helped me grow my frontend and backend skills and taught me how to work well in a team.</p>
            </div>
